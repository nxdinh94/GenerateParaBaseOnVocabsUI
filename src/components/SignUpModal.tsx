  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-center">Đăng ký tài khoản</DialogTitle>
        ...
        <div className="space-y-4">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="space-y-2">
              <Label htmlFor="modal-fullName">Họ và tên</Label>
            ...
            <div className="space-y-2">
              <Label htmlFor="modal-confirmPassword">Xác nhận mật khẩu</Label>
              <div className="relative">
                <Lock className="absolute left-3 top-3 h-4 w-4 text-muted-foreground" />
                <Input
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-2">
                <input
                  ...
                  required
                />
                <Label htmlFor="modal-acceptTerms" className="text-sm">
                  Tôi đồng ý với{' '}
                  <button
                    type="button"
              ...
              <div className="flex items-center space-x-2">
                <input
                  ...
                  className="h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary"
                />
                <Label htmlFor="modal-subscribeNewsletter" className="text-sm">
